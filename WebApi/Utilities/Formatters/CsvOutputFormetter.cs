...
{
    public class CsvOutputFormetter : TextOutputFormatter
    {
        public CsvOutputFormetter()
        {
        ...
        private static void FormaCsv(StringBuilder buffer, BookDto book)
        {
        ...
        public override async Task WriteResponseBodyAsync(OutputFormatterWriteContext context, Encoding selectedEncoding)
        {
            ...
            if (context.Object is IEnumerable<BookDto>)
            {
                ...
                {
                    FormaCsv(buffer, book);
                }
            }
            else
            {
                FormaCsv(buffer, (BookDto)context.Object);
            }
